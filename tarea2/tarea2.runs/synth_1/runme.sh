...
HD_PWD='C:/Users/ivanv/tarea2/tarea2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tarea2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tarea2.tcl
